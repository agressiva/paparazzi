...
#define CAM_SHOT_TIME           10//6 4
#define CAM_SHOT_PULSE_TIME    10//
...
void periodic_task_kamera(void) //4Hz
{
  ...
  //meu teste
  test_agr++;  
 //   if(test_agr == 20)  if (SHOT_VIDEO) LED_TOGGLE(2);  //green
  // fim meu teste
  ...
  on = TRUE; //cam_alt_on && (cam_climb_on <= 0) && cam_on;// 
